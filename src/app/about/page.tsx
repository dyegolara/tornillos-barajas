        ...
        <Flex direction="column" gap="4">
          ...
          <Card variant="classic" size={{ initial: "2", sm: "3" }}>
            ...
            <Text as={"p"}>
              ...
              que nos soliciten como galvanizado natural, verde, negro,
              cobrizado, cadminizado, niquelado, etc. Nos hemos especializado en
              la fabricación de tornillos con medidas y características muy
